...
const translations = {
  zh: {
    ...
    searchMode: "搜索模式",
    smartSearch: "智能识别",
    pasteTextPlaceholder: "粘贴论文摘要、描述或引用文字...",
    extracting: "正在识别...",
    extractedInfo: "识别结果",
    extractedKeywords: "关键词",
    extractedTitle: "识别标题",
    extractAndSearch: "识别并搜索",
    // Search Suggestions
    hotSearches: "热门搜索",
    recentSearches: "最近搜索",
    clearHistory: "清空历史",
    ...
    // Example Queries
    exampleQueries: "试试这些",
    exampleQuery1: "深度学习图像分类最新论文",
    exampleQuery2: "Transformer 在 NLP 中的应用",
    exampleQuery3: "大语言模型推理优化",
    exampleQuery4: "图神经网络推荐系统",
    // Paper Source
    paperSource: "来源",
    sourceArxiv: "arXiv",
    // Navigation
  ...
  en: {
    ...
    downloadToKB: "Download to KB",
    downloading: "Downloading...",
    downloadSuccess: "Download successful",
    downloadFailed: "Download failed",
    arxivLink: "arXiv Link",
    authors: "Authors",
    published: "Published",
    abstract: "Abstract",
    ...
    noKB: "No knowledge base, please create one first",
    pleaseLogin: "Please login first",
    enterKeyword: "Please enter a search keyword",
    // Search Mode
    keywordSearch: "Keyword Search",
    naturalLanguageSearch: "Natural Language",
    searchMode: "Search Mode",
    smartSearch: "Smart Extract",
    pasteTextPlaceholder: "Paste paper abstract, description or citation...",
    extracting: "Extracting...",
    extractedInfo: "Extracted Info",
    extractedKeywords: "Keywords",
    extractedTitle: "Detected Title",
    extractAndSearch: "Extract & Search",
    // Search Suggestions
    ...
    // Example Queries
    exampleQueries: "Try these",
    exampleQuery1: "Recent deep learning image classification papers",
    exampleQuery2: "Transformer applications in NLP",
    exampleQuery3: "Large language model inference optimization",
    exampleQuery4: "Graph neural networks for recommendation",
    // Paper Source
    paperSource: "Source",
    sourceArxiv: "arXiv",
    // Navigation
